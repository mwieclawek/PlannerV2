...
logging.basicConfig(
    ...
    handlers=[
        RotatingFileHandler("logs/planner.log", maxBytes=5*1024*1024, backupCount=3),
...
_raw_origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:5000,http://127.0.0.1:5000,http://localhost:8080,http://127.0.0.1:8080")
