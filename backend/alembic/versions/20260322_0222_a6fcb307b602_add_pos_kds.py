...
def upgrade() -> None:
    ...
    if is_postgres:
        # Pre-create Enum types for PostgreSQL if they don't exist
    ...
    if 'menuitem' not in existing_tables:
    ...
    if 'restauranttable' not in existing_tables:
    ...
    if 'kitchenorder' not in existing_tables:
    ...
    if 'kitchenorderitem' not in existing_tables:
...
def downgrade() -> None:
    ...
    if bind.dialect.name == 'postgresql':
        ...
        op.execute("DROP TYPE IF EXISTS kitchenorderstatus")
    # ### end Alembic commands ###
